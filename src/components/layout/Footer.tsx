  ...
  return (
    <footer ref={ref} className="bg-charcoal text-white/80 relative">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12">
        {/* Main Footer */}
        <div className="py-16 sm:py-24 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 sm:gap-14 lg:gap-24">
          {/* Brand */}
          <ScrollReveal direction="up" className="sm:col-span-2 md:col-span-1">
            <div>
              <h2 className="font-display text-2xl sm:text-3xl mb-6 text-white tracking-wide">HALSON PAINTS</h2>
              <p className="text-white/35 leading-relaxed text-sm max-w-xs font-light">
          ...
          <ScrollReveal delay={0.1}>
            <div>
              <h3 className="text-[10px] tracking-[0.3em] uppercase text-white/25 mb-7 font-medium">
                Navigation
              </h3>
              <ul className="space-y-5">
                {[
                  ...
                  <li key={link.path}>
                    <Link 
                      to={link.path} 
                      className="text-white/40 hover:text-white transition-colors duration-500 text-sm font-light inline-block"
                    >
                      {link.name}
                    </Link>
                  </li>
        ...
        {/* Bottom Bar */}
        <div className="py-7 border-t border-white/[0.06] flex flex-col sm:flex-row items-center justify-between gap-4">
